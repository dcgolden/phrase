...
<ul>
  ...
  <li><code>ajax.username</code> + <code>ajax.password</code>: You can specify HTTP auth parameters either by using a database with a name in the form <code>http://user:pass@host/name</code> or via the <code>username</code> + <code>password</code> options.</li>
</ul>
...
<p>You can also download this plugin <a href="https://github.com/pouchdb/pouchdb/releases/download/3.4.0/pouchdb.localstorage.js">as a standalone script</a>.</p>
...
<p>You can also download this plugin <a href="https://github.com/pouchdb/pouchdb/releases/download/3.4.0/pouchdb.memory.js">as a standalone script</a>.</p>
...
<p>You can also download this plugin <a href="https://github.com/pouchdb/pouchdb/releases/download/3.4.0/pouchdb.idb-alt.js">as a standalone script</a>.</p>
