    ...
    <header>
      ...
      <div class="page-head">
        ...
        <div class="container">
          ...
          <h1>PouchDB 3.5.0&#58; Vote for PouchDB</h1>
...
<ul>
<li>Fallback to the <a href="https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API">fetch API</a> where XMLHTTPRequest does not exist (in Service Workers) (<a href="https://github.com/pouchdb/pouchdb/pull/3678">#3678</a>)</li>
...
<li>Work on supporting Webpack (<a href="https://github.com/pouchdb/pouchdb/issues/3319">#3319</a>)</li>
</ul>
